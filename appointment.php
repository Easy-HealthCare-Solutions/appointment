		...
		<div class="sub-main-w3">
			<div class="bg-content-w3pvt">
				...
				<form action="#" method="post">
					...
					<div class="input">
						<input type="number" name="mob_number" class="form-control" placeholder="Mobile_number" required />
          </div>
          <div class="input">
...
$query = "INSERT INTO common (patient_name,mob_number,doctor_type) VALUES ('$name','$mob_number','$doctor_type')";
mysqli_query($conn,$query);



$query = "INSERT INTO $name (patient_name,mob_number,doctor_type) VALUES ('$name','$mob_number','$doctor_type')";
mysqli_query($conn,$query); 
     }
